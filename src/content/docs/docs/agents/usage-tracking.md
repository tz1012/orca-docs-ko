...
Orca은 Claude Code, Codex, Gemini, OpenCode, Kimi Code 및 MiniMax의 로컬 사용 상태를 읽고 이를 상태 표시줄에 표시하므로 에이전트가 중단되기 전에 속도 제한에 얼마나 근접했는지 알 수 있습니다.

## 표시되는 내용

- 활성 계정의 계획에 대한 현재 사용량입니다.
- 5시간, 일일, 주간 및 Claude Fable 주간 창(해당하는 경우)에 대한 재설정 시간입니다.
